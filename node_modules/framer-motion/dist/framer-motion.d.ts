 ...
 * @internal
 */
export declare const createMotionComponent: <P extends {}>({ getValueControlsConfig, loadFeatures, renderComponent, }: MotionComponentConfig) => React.ForwardRefExoticComponent<React.PropsWithoutRef<P & MotionProps> & React.RefAttributes<Element>>;
 ...
 * @public
 */
declare function custom<Props>(Component: string | React.ComponentType<Props>): React.ForwardRefExoticComponent<React.PropsWithoutRef<Props & MotionProps> & React.RefAttributes<Element>>;
...
declare type LoadMotionFeatures<P = {}> = (nativeElement: NativeElement, values: MotionValuesMap, props: P & MotionProps, context: MotionContextProps, parentContext: MotionContextProps, controls: ValueAnimationControls<P>, inherit: boolean, plugins: MotionPluginsContext) => React.ReactElement<FeatureProps>[];
...
declare type MakeTargetAnimatable = (target: TargetWithKeyframes, origin?: Target, transitionEnd?: Target) => {
...
declare interface MotionComponentConfig {
    ...
    getValueControlsConfig: (nativeElement: NativeElement, values: MotionValuesMap) => ValueAnimationConfig;
}
...
declare class NativeElement<E extends Element = Element> {
    hasMounted: boolean;
    stylerConfig: StylerConfig;
    externalRef?: Ref<E>;
    current: E;
    styler: Styler;
    mountSubscriptions: Map<Symbol, Subscription>;
    unmountSubscriptions: Map<Symbol, Subscription>;
    constructor(stylerConfig: StylerConfig, externalRef?: Ref<E>);
    mount(element: E): void;
    unmount(): void;
    onMount(id: Symbol, sub: Subscription): () => boolean;
    onUnmount(id: Symbol, sub: Subscription): () => boolean;
...
declare type RenderComponent<P = {}> = (nativeElement: NativeElement, style: React.CSSProperties, values: MotionValuesMap, props: P, isStatic?: boolean) => React.ReactElement;
...
declare interface StylerConfig {
}
...
declare type Subscription<E extends Element = Element> = (nativeElement: NativeElement<E>) => void;
 ...
 * @public
 */
export declare function useGestures<GestureHandlers>(props: GestureHandlers, ref: NativeElement): void;
 ...
 * @internal
 */
export declare function usePanGesture({ onPan, onPanStart, onPanEnd, onPanSessionStart }: PanHandlers, ref: RefObject<Element> | NativeElement): void;
