(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var int = /*#__PURE__*/__assign$2( /*#__PURE__*/__assign$2({}, number$1), { transform: Math.round });
    var valueTypes = {
        color: color$1,
    ...
    function createCssStyler(element, _a) {
        ...
        return cssStyler(__assign$2({ element: element, buildStyles: createStyleBuilder({
    ...
    var buildStyleAttr = function (values, styleProp, props, isStatic) {
        ...
        return buildStyleProperty(__assign$2(__assign$2({}, styleProp), motionValueStyles), !isStatic);
    };
    ...
    var useMotionStyles = function (values, styleProp, transformValues) {
        ...
        for (var key in styleProp) {
            ...
            else if (isTransformProp(key) || isTransformOriginProp$1(key)) {
    ...
    var Action = /*#__PURE__*/function () {
        ...
        Action.prototype.start = function (observerCandidate) {
            ...
            subscription = api ? __assign$2({}, subscription, api) : subscription;
            if (isComplete) subscription.stop();
            return subscription;
        };
        Action.prototype.applyMiddleware = function (middleware) {
            return this.create(__assign$2({}, this.props, { middleware: this.props.middleware ? [middleware].concat(this.props.middleware) : [middleware] }));
        };
    ...
    var createUnitAction = function (action, _a) {
        ...
        return action(__assign$2({}, props, { from: typeof from === 'string' ? parse(from) : from, to: typeof to === 'string' ? parse(to) : to })).pipe(transform);
    };
    var createMixerAction = function (mixer) {
        return function (action, _a) {
            var from = _a.from,
                to = _a.to,
                props = __rest(_a, ["from", "to"]);
            return action(__assign$2({}, props, { from: 0, to: 1 })).pipe(mixer(from, to));
        };
    };
    ...
    var inertia = function (_a) {
        ...
        return action(function (_a) {
            ...
            var startSpring = function (props) {
                isSpring = true;
                startAnimation(vectorSpring(__assign$2({}, props, { to: isLessThanMin(props.from) ? min : max, stiffness: bounceStiffness, damping: bounceDamping, restDelta: restDelta })));
            };
    ...
    var keyframes = function (_a) {
        ...
        return tween(__assign$2({}, tweenProps, { ease: ease })).applyMiddleware(function (update) {
    ...
    var getTransitionDefinition = function (key, to, transitionDefinition) {
        ...
        if (transitionDefinition === undefined ||
            ...
            return __assign$2({ delay: delay }, getDefaultTransition(key, to));
        }
        ...
        if (valueTransitionDefinition.type === false) {
            ...
            return __assign$2(__assign$2({ values: to, duration: 0.8, delay: delay, ease: "linear" }, valueTransitionDefinition), { 
                // This animation must be keyframes if we're animating through an array
                type: "keyframes" });
        }
        else {
            return __assign$2({ type: "tween", to: to,
    ...
    var getAnimation = function (key, value, target, transition) {
        ...
        var actionFactory = isOriginAnimatable && isTargetAnimatable
            ? transitions[type]
            : just;
        var opts = preprocessOptions(type, __assign$2({ from: origin, velocity: value.getVelocity() }, transitionDefinition));
    ...
    var ValueAnimationControls = /** @class */ (function () {
        ...
        ValueAnimationControls.prototype.setValues = function (definition, _a) {
            ...
            target = this.transformValues(__assign$2(__assign$2({}, target), transitionEnd));
        ...
        ValueAnimationControls.prototype.animate = function (animationDefinition, _a) {
            ...
            for (var key in target) {
                ...
                animations.push(startAnimation(key, value, valueTarget, __assign$2({ delay: delay }, transition)));
            }
    ...
    function fixTransparentRGB(a, b) {
        ...
        var fixed = isBlack && isTransparent ? __assign$2(__assign$2({}, b), { alpha: 0 }) : a;
    ...
    var NativeElement = /** @class */ (function () {
        ...
        NativeElement.prototype.mount = function (element) {
            ...
            this.styler = index(element, this.stylerConfig);
    ...
    function MotionPlugins(_a) {
        ...
        var value = React.useRef(__assign$2({}, pluginContext)).current;
    ...
    function convertPanToDrag(info, point) {
        return __assign$2(__assign$2({}, info), { point: {
    ...
    function useDrag(props, nativeElement, values, controls) {
        ...
        dragControls.updateProps(__assign$2(__assign$2({}, props), { transformPagePoint: transformPagePoint }));
    ...
    var Auto = /** @class */ (function (_super) {
        ...
        function Auto(props) {
            ...
            _this.supportedAutoValues = __assign$2(__assign$2({}, defaultMagicValues), autoValues);
        ...
        Auto.prototype.startLayoutAnimation = function (opts) {
            ...
            if (animate !== false) {
                ...
                if (!dragControls || !dragControls.isDragging) {
                    animation = startAnimation("progress", this.progress, progressTarget, __assign$2(__assign$2({}, (opts.transition || transition)), { restDelta: 1, restSpeed: 10 })).then(function () { return _this.safeToRemove(); });
                }
                else {
    ...
    function targetWithoutTransition(_a, mergeTransitionEnd) {
        ...
        return mergeTransitionEnd
            ? __assign$2(__assign$2({}, target), transitionEnd)
            : target;
    }
    /**
    ...
    function useAnimateProp(targetAndTransition, controls, values, defaultTransition) {
        ...
        React.useEffect(function () {
            ...
            isInitialRender.current = false;
            prevValues.current = __assign$2(__assign$2({}, prevValues.current), finalTarget);
            if (Object.keys(targetToAnimate).length) {
                controls.start(__assign$2(__assign$2({}, targetToAnimate), { transition: targetAndTransition.transition || defaultTransition, transitionEnd: targetAndTransition.transitionEnd }));
            }
        }, [targetAndTransition]);
    }
            ...
            React.useEffect(function () {
                if (!isPresent) {
                    if (!isPlayingExitAnimation.current && exit) {
                        controls.setProps(__assign$2(__assign$2({}, props), { custom: custom }));
    ...
    var buildSVGProps = function (values, style) {
        ...
        props.style = __assign$2(__assign$2({}, style), props.style);
        return props;
    };
    ...
    function createDomMotionConfig(ComponentToRender) {
        ...
        return {
            renderComponent: function (nativeElement, style, values, props, isStatic) {
                ...
                return React.createElement(ComponentToRender, __assign$2(__assign$2(__assign$2({}, forwardedProps), { ref: nativeElement.ref }), staticVisualStyles));
            },
            /**
            ...
            loadFeatures: function (nativeElement, values, props, context, parentContext, controls, inherit, plugins) {
                ...
                for (var i = 0; i < numFeatures; i++) {
                    ...
                    if (shouldRender(props, parentContext)) {
                        activeComponents.push(React.createElement(Component, __assign$2({ key: key }, props, { localContext: context, parentContext: parentContext, values: values, controls: controls, nativeElement: nativeElement })));
                    }
                }
    ...
    var PresenceChild = function (_a) {
        ...
        return (React.createElement(PresenceContext.Provider, { value: __assign$2(__assign$2({ id: id }, context), { register: register }) }, children));
    };
            ...
            _this.state = {
                ...
                forceRender: function () {
                    if (!_this.isAnimating) {
                        _this.shouldRerender = false;
                        _this.setState(__assign$2({}, _this.state));
                    }
                    else {
        ...
        AnimateSharedLayout.prototype.startAnimation = function () {
            ...
            var handler = {
                ...
                startAnimation: function (child) {
                    ...
                    var animation = child.startAnimation(__assign$2(__assign$2(__assign$2({}, options), config), { shouldAnimate: shouldAnimate }));
                    if (!animation)
                        return;
    ...
    function transform() {
        ...
        var interpolator = interpolate(inputRange, outputRange, __assign$2({ mixer: getMixer$1(outputRange[0]) }, options));
    ...
    function useSpring(source, config) {
        ...
        React.useMemo(function () {
            return value.attach(function (v, set) {
                ...
                activeSpringAnimation.current = vectorSpring(__assign$2({ from: value.get(), to: v, velocity: value.getVelocity() }, config)).start(set);
                return value.get();
            });
    ...
    function ReducedMotion(_a) {
        ...
        var context = React.useContext(MotionContext);
        context = React.useMemo(function () { return (__assign$2(__assign$2({}, context), { isReducedMotion: enabled })); }, [enabled]);
